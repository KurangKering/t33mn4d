...
<div class="">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="x_panel" >
				<div class="x_title" id="header-panel-container">
		...
		<div class="x_content" id="panel-container">
...
<script>
	...
	let widthPanel = $("#panel-container").width();
	let widthHeaderCard = $("#header-panel-container").width();
			...
			var options = {
				series: [{
					...
					dataLabels: {
						...
						useHTML: true,
						formatter() {
							return "<div class=\"text-center\">" + this.point.name + "<br>" + this.point.value+ " Pasien</div>";
						}
