...
function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function(e) {
        ...
        $BODY.hasClass("nav-md") ? ($LOGO_KIRI.addClass('gambar-penuh'), $SIDEBAR_MENU.find("li.active ul").hide(), $SIDEBAR_MENU.find("li.active").addClass("active-sm").removeClass("active")) : ($LOGO_KIRI.removeClass('gambar-penuh'), $SIDEBAR_MENU.find("li.active-sm ul").show(), $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")), $BODY.toggleClass("nav-md nav-sm"), t(), $(".dataTable").each(function() {
...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        if (console.lo, Chart.defaults.global.legend = {
                enabled: !1
